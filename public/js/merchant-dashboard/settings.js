...
$(document).ready(function () {
    ...
    $("#daySelect").click(function () {
        _M.FormSelect.init(document.querySelectorAll("select"));
    });
    ...
    $("#addOpenHour").click(function () {
        ...
        if (!day || !time || !slots) {
            _M.toast({ html: "Please fill all fields!", classes: "red" });
            return;
        }
        ...
        _M.FormSelect.init(document.querySelectorAll("select")); // Reinitialize Materialize select
    });
    ...
    $("#saveOpenHours").click(function () {
        $.ajax({
            ...
            success: function (response) {
                _M.toast({ html: "Open hours updated!", classes: "green" });
            },
            error: function () {
                _M.toast({ html: "Error saving open hours!", classes: "red" });
            }
        });
    });
    ...
    $("#merchantForm").submit(function (e) {
        ...
        $.ajax({
            ...
            success: function (response) {
                _M.toast({ html: "Merchant details saved!", classes: "green" });
            },
            error: function () {
                _M.toast({ html: "Error saving merchant details!", classes: "red" });
            }
        });
    });
});